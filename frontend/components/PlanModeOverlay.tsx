...
export interface PlanModeOverlayProps {
  ...
  outcomeText?: string;
  /** Called when user clicks Yes in the final modal. */
  onYes: () => void;
  /** Called when user clicks No in the final modal. */
  onNo: () => void;
          ...
          <div className="flex-none border-b border-slate-700/50 px-4 py-5 bg-slate-900/50">
            ...
            <div className="mx-auto max-w-4xl">
              {(() => {
                ...
                const nodes = [...pathLabels.map((l, i) => ({ label: l, isPrediction: false, i })), { label: "Prediction", isPrediction: true, i: pathLabels.length }];
                return (
                  <div className="grid w-full" style={{ gridTemplateColumns: `repeat(${n}, 1fr)` }}>
                    ...
                    >
                      <span className="block text-center text-xs font-medium text-white truncate w-full px-0.5">Prediction</span>
                    </div>
                  </div>
                );
              })()}
          ...
          >
            <div className="mx-auto max-w-2xl space-y-6">
              ...
              <p className="text-xs text-slate-500">
                Path: {pathLabels.join(" → ")} → Prediction
              </p>
